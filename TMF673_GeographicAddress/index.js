...
try {
  ...
  logger.error('Unable to replace swagger-ui-dist/index.html file', { error: err.message });
  process.exit(1);
}
...
swaggerTools.initializeMiddleware(swaggerDoc, function (middleware) {
  ...
  // Enhanced with HATEOAS-style links for API discoverability
 ...
 // });
  ...
  http.createServer(app).listen(serverPort, function () {
    ...
    logger.info(`Swagger UI available`, {
      url: `http://localhost:${serverPort}/docs`
    });
  });
